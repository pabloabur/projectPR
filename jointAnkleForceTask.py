...
class jointAnkleForceTask(object):
    ...
    def computeTorque(self, t):
        ...
        torque -= 1100*velocity + 320*self.ankleAngle_rad[int(np.rint(t / self.conf.timeStep_ms))] + 7455*acceleration + 2.01*0.055*math.sin(self.ankleAngle_rad[int(np.rint(t / self.conf.timeStep_ms))])
