...
cdef double compRon(double Non, double rInf, double Ron, double t0, double t, double tauOn):
    '''
...
cdef double compRoff(double Roff, double t0, double t, double tauOff):
    '''
    Computes the fraction of postsynaptic receptors
    that are bound to neurotransmitters of all the individual synapses
...
def compRiStart(ri, double t, ti, double tPeak, double tauOff):
    '''
